...
import {
  ...
  Plug, Wrench, ChevronDown, ChevronLeft, ChevronRight,
} from "lucide-react";
...
const HERO_SLIDES = [
  ...
  {
    tag: "ESG & CO2 Impact Calculator",
    lines: [
      "What could accurate",
      <>carbon reporting <span className="text-leaf">save you?</span></>,
    ],
    sub: "Answer four quick questions and see the potential CO2e reporting and compliance impact of switching to Green Mind Learning — modeled live from your inputs.",
    img: IMAGES.leafSun,
    alt: "Sunlight filtering through fresh green leaves",
    primary: { label: "Calculate Your ESG & CO2 Impact", to: "/#esg-co2-calculator", testid: "hero-esg-button" },
      ...
      <section className="bg-mist px-6 py-24 lg:px-10 lg:py-28" data-testid="services-teaser-section">
        <div className="mx-auto max-w-[1400px]">
          ...
          <Reveal className="mt-10">
            <ButtonLink to="/about-contact#contact" variant="outline" testid="services-teaser-cta" arrow>
